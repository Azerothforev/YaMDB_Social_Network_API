# Generated by Django 3.2 on 2023-03-09 20:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'пользователь'), ('moderator', 'модератор'), ('admin', 'администратор'), ('superuser', 'суперпользователь')], default='user', max_length=9, verbose_name='Статус на сайте')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Краткий URL')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('basegroupmodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='reviews.basegroupmodel')),
            ],
            options={
                'verbose_name': 'Категории',
                'verbose_name_plural': 'Категории',
            },
            bases=('reviews.basegroupmodel',),
        ),
        migrations.CreateModel(
            name='Genre',
            fields=[
        ...
        migrations.AddField(
            model_name='title',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='titles_cat', to='reviews.category', verbose_name='Категория'),
        ),
        migrations.AddField(
            model_name='title',
            name='genre',
            field=models.ManyToManyField(related_name='titles_gen', through='reviews.GenreToTitle', to='reviews.Genre', verbose_name='Жанр'),
        ),
